  				...
  				<div class="collapse navbar-collapse" id="navbarNavDropdown">
    				...
    				<ul class="navbar-nav">
      					<li class="nav-item active">
        					<a class="nav-link menutext" href="index.php">Home <span class="sr-only">(current)</span></a>
      					</li>
                		<li class="nav-item">
                  			<a class="nav-link menutext" href="contact_us.php">Contact us</a>
                		</li>
                		<li class="nav-item">
                  			<a class="nav-link menutext" href="about_us.php">About us</a>
                		</li>
    				</ul>
