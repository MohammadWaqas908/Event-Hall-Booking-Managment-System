  				...
  				<div class="collapse navbar-collapse" id="navbarNavDropdown">
    				...
    				<ul class="navbar-nav">
      					<li class="nav-item active">
        					<a class="nav-link menutext" href="user_dash.php">Home <span class="sr-only">(current)</span></a>
      					</li>
                		<li class="nav-item">
                  			<a class="nav-link menutext" href="booking_request.php">Booking Hall Request</a>
                		</li>
                		<li class="nav-item">
                  			<a class="nav-link menutext" href="feedback.php">Feedback</a>
                		</li>
    				</ul>
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
